...
"""multiplecmd is a module that simplifies and automates some aspects of subprocess"""
...
class Runner(BaseArgs):
    ...
    Runner takes N positional arguments, and optionally:
        ...
        Usage:
            cmd = Runner('ls -l','df -h',verbose = True,delay = 1)
            cmd.run() """
    def run(self):
